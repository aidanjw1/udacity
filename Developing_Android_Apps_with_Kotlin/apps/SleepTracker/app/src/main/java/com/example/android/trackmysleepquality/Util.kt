...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMili != it.startTimeMilli) {
                ...
                // Hours
                append("\t ${it.endTimeMili.minus(it.startTimeMilli) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTimeMili.minus(it.startTimeMilli) / 1000 / 60}:")
                // Seconds
                append("${it.endTimeMili.minus(it.startTimeMilli) / 1000}<br><br>")
            }
        }
    }
